...
const filtered = computed(() => {
    ...
    return props.items.filter(
        (it) => it.title.toLowerCase().includes(q) || it.meta.toLowerCase().includes(q),
    )
})
</script>
    ...
    <template v-if="open">
        ...
        >
            <div class="flex-none border-b border-outline-variant px-6 py-5">
                ...
                <div
                    class="mt-4 flex items-center gap-2 rounded-full border border-outline-variant bg-surface px-3.5 py-2"
                >
